...
//	}
	...
	function withIndexedDB(db) {
		...
		// ----------------------------------------
		// MAIN JS
		var mainJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/almazufa/tilda3dsite/35ef129c97619db7d93f6c58469a336ef0d8e3d2/MyProject3-HTML5-Shipping.js'), 'blob').then(function(data) {
		...
		// ----------------------------------------
		// MORE JS
		var dataJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/almazufa/tilda3dsite/3ced78e3093a46116236f8b28d9e930de474fd6d/MyProject3-HTML5-Shipping.data.js'));
		var utilityJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/almazufa/tilda3dsite/35ef129c97619db7d93f6c58469a336ef0d8e3d2/Utility.js')).then(addScriptToDom);
		var dataDownload =
...
// Instead as a fallback, download as ArrayBuffer. (TODO: Figure out the bugs with the above, and switch to using that one instead)
			fetchOrDownloadAndStore(db, Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/rfqwafqowpue4msmdv1nl/MyProject3-HTML5-Shipping.data?rlkey=3lu541dl2hgh6h5hbwnx1r5v9&dl=0'), 'arraybuffer').then(function(dataArrayBuffer) {
				Module['preloadedPackages'] = {};
				Module['preloadedPackages'][Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/rfqwafqowpue4msmdv1nl/MyProject3-HTML5-Shipping.data?rlkey=3lu541dl2hgh6h5hbwnx1r5v9&dl=0')] = dataArrayBuffer;
				return dataJsDownload.then(addScriptToDom);
			});
